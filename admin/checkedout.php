...
<html>
<head>
<title><?php echo $church_name;?> | <?php echo $vbs_title;?> | <?php echo $vbs_year;?> | Admin | All children checked out</title>
...
<div class="w3-container">        
        <h3><u>Children >> Who checked out?</u></h3>
</div>
<p></p>
<div class="w3-container">
<?php
...
$sql = "SELECT * FROM `checkout` RIGHT JOIN reg_entries ON checkout.co_cid=reg_entries.cid RIGHT JOIN grp ON grp.grpid=reg_entries.stgrpid WHERE checkout.co_cid IS NOT NULL AND checkout.co_day IS NOT NULL";
