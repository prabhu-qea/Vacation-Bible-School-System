...
<div class="w3-container">        
        <h3><u>Children >> Registered</u></h3>
</div>        
<div class="w3-container">
<?php
// include '../inc/db.php';

$sql = "SELECT * FROM `reg_entries` LEFT JOIN grp ON reg_entries.stgrpid=grp.grpid WHERE grp.gname!=''; ";
...
?>
            ...
            <div class="w3-container w3-center">
                <p><span class="w3-badge w3-xxxlarge w3-padding w3-green"><?php echo $result->num_rows; ?></span> Children registered.</p>
            </div>            
            <p></p>            
